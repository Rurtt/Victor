...
TEXT = {
    "Victor • Personal assistant": "Victor • ผู้ช่วยส่วนตัว",
    ...
    "A little help. More headspace.": "แชตกับ Victor",
    "Stop": "หยุด",
    ...
    "Victor — AI settings": "Victor — ตั้งค่า AI",
    ...
    "Thinking with Gemini… • Microphone off": "Victor กำลังคิด… • ไมโครโฟนปิด",
    "Thinking with Gemini…": "Victor กำลังคิด…",
    ...
    "Victor — approve one PC action": "Victor — ตรวจสอบการทำงาน",
    "Review before running": "ตรวจสอบก่อนให้ Victor ทำงาน",
    ...
    "Victor — PC actions": "Victor — ควบคุมคอมพิวเตอร์",
    "Useful things, one click away": "ให้ Victor ช่วยทำงาน",
    ...
    "Victor — summarize": "Victor — สรุปข้อความ",
